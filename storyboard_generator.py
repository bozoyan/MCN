...
class VLMSettingsDialog(QDialog):
    ...
    def init_ui(self):
        ...
        api_layout.addWidget(QLabel("抑制预览输出:"), 2, 0)
        api_layout.addWidget(self.suppress_preview_check, 2, 1)
    ...
    def load_current_config(self):
        ...
        self.model_edit.setText(self.vlm_config.get("model", "SiliconFlow:Qwen/Qwen3-VL-8B-Instruct"))
    ...
    def save_settings(self):
        ...
        self.vlm_config.set("model", self.model_edit.text().strip())
